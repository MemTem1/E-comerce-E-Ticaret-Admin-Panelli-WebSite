    ...
    return (
        <div className="single-tabs">
            <ul className="tab-list">
                <li>
                    <a href="#" className={`tab-button ${activeTab === "desc" ? "active" : ""}`} onClick={(e) => { hendleTabClick(e, "desc") }}>
                        Description
                    </a>
                </li>
                <li>
                    <a href="#" className={`tab-button ${activeTab === "info" ? "active" : ""}`} onClick={(e) => { hendleTabClick(e, "info") }}>
                        Additional information
                    </a>
                </li>
                <li>
                    <a href="#" className={`tab-button ${activeTab === "reviews" ? "active" : ""}`} onClick={(e) => { hendleTabClick(e, "reviews") }}>
                        Reviews
                    </a>
                </li>
            </ul>
            ...
            <div className="tab-panel">
                <div className={`tab-panel-descriptions content ${activeTab === "desc" ? "active" : ""}`} id="desc">
                    <p>
                        ...
                        in pellentesque lorem mattis quis.
                    </p>
                    <br />
                    <p>
                        Quisque varius diam vel metus mattis, id aliquam diam rhoncus. Proin
